module LookFor
  ...
  class ProductService
    ...
    def self.custom_method(search, profiles, categories, subcategories, states, countries)
      ...
      products_by_filters = products_by_filters.uniq.as_json(only: %i[id type_profile name stock price cover created_at updated_at states_codes countries_codes], methods: %i[productable category_ids subcategory_ids links url_get])
