...
ActiveRecord::Schema.define(version: 20200531224542) do
  ...
  create_table "wave_citizen_items", force: :cascade do |t|
    t.string "title"
    t.text "description"
    t.bigint "poll_id"
    t.datetime "deleted_at"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["poll_id"], name: "index_wave_citizen_items_on_poll_id"
  end

  create_table "wave_citizen_poll_categories", force: :cascade do |t|
    t.string "name"
    t.bigint "country_id"
    t.datetime "deleted_at"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["country_id"], name: "index_wave_citizen_poll_categories_on_country_id"
  end

  create_table "wave_citizen_polls", force: :cascade do |t|
    t.string "title"
    t.text "description"
  ...
  create_table "wave_citizen_proposals", force: :cascade do |t|
    t.string "title"
    t.text "description"
    t.integer "citizen_id"
    t.integer "user_id"
  ...
  create_table "wave_citizen_votes", force: :cascade do |t|
    t.boolean "vote"
    t.string "votable_type"
    t.bigint "votable_id"
    t.bigint "user_id"
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["poll_id"], name: "index_wave_citizen_votes_on_poll_id"
    t.index ["user_id", "votable_id", "votable_type", "poll_id"], name: "wcv_votables", unique: true
    t.index ["user_id"], name: "index_wave_citizen_votes_on_user_id"
    t.index ["votable_type", "votable_id"], name: "index_wave_citizen_votes_on_votable_type_and_votable_id"
  end
